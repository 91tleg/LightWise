...
namespace lorawan
{
    ...
    namespace
    {
        ...
        constexpr uint32_t kBeginRetryCount    { 10U };
    ...
    bool Lwnode::setAppEui( const char * const appEuiHex ) noexcept
    {
        bool result { false };
        ...
        if( appEuiHex != nullptr )
        {
            ...
            if( sendAtCmd( cmd, ack, sizeof( ack ) ) )
            {
                result = ackEquals( ack, "+JOINEUI=OK\r\n" );
            }
        }
    ...
    bool Lwnode::setAppKey( const char * const appKeyHex ) noexcept
    {
        bool result { false };
        ...
        if( appKeyHex != nullptr )
        {
            ...
            if( sendAtCmd( cmd, ack, sizeof( ack ) ) )
            {
                result = ackEquals( ack, "+APPKEY=OK\r\n" );
            }
        }
    ...
    bool Lwnode::setNwkSkey( const char * const nwkSkeyHex32 ) noexcept
    {
        bool result { false };
        ...
        if( nwkSkeyHex32 != nullptr )
        {
            ...
            if( n == kNwkSKeyHexChars )
            {
                ...
                static_cast< void >( std::memcpy( nwkSkey_, nwkSkeyHex32, kNwkSKeyHexChars ) );
                nwkSkey_[ kNwkSKeyHexChars ] = '\0';
                str_ext_to_upper_case( nwkSkey_ );

                static_cast< void >( std::memcpy( cmd, kNwkSKeyPrefix, kNwkSKeyPrefixLen ) );
                static_cast< void >( std::memcpy( &cmd[ kNwkSKeyPrefixLen ], nwkSkey_, kNwkSKeyHexChars ) );
    ...
    bool Lwnode::setAppSkey( const char * const appSkeyHex32 ) noexcept
    {
        bool result { false };
        ...
        if( appSkeyHex32 != nullptr )
        {
            ...
            if( n == kAppSKeyHexChars )
            {
                ...
                static_cast< void >( std::memcpy( appSkey_, appSkeyHex32, kAppSKeyHexChars ) );
                appSkey_[ kAppSKeyHexChars ] = '\0';
                str_ext_to_upper_case( appSkey_ );

                static_cast< void >( std::memcpy( cmd, kAppSKeyPrefix, kAppSKeyPrefixLen ) );
                static_cast< void >( std::memcpy( &cmd[ kAppSKeyPrefixLen ], appSkey_, kAppSKeyHexChars ) );
    ...
    bool Lwnode::setDevAddr( uint32_t devAddr ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::setClass( DeviceClass classType ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::setDatarate( uint8_t dataRate ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::setEirp( uint8_t eirp ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::setSubband( uint8_t subBand ) noexcept
    {
        bool result { false };
        ...
        if( region_ != Region::EU868 )
        {
            ...
            if( num_fmt_u8toa( subBand, numStr, sizeof( numStr ) ) )
            {
                ...
                static_cast< void >( std::memcpy( cmd, kSubbandPrefix, kSubbandPrefixLen ) );
                static_cast< void >( std::memcpy( &cmd[ kSubbandPrefixLen ], numStr, len ) );
    ...
    bool Lwnode::enableAdr( bool adr ) noexcept
    {
        bool result { false };
                             ...
                             uint8_t len ) noexcept
    {
        ...
        {    
            ...
            if( num_fmt_hex_encode( data, len, hex, sizeof( hex ) ) )
            {
                ...
                {
                    char ack[ kAtAckMaxLen ] {};
                    static_cast< void >( std::strncat( cmd, hex, sizeof( cmd ) - 9U ) );
    ...
    bool Lwnode::sleepMs( uint32_t ms ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::readData( uint8_t * const out, 
                           uint16_t outMax, 
                           uint16_t * const outLen ) noexcept
    {
        bool result { false };
            ...
            *outLen = 0U;
            ...
            if( readLoraData( &rxLen ) )
            {
                ...
                if( rxLen > static_cast< uint16_t >( kLorawanRxMetadataOffset ) )
                {
                    ...
                    static_cast< void >( std::memcpy( out, &rxBuf_[ kLorawanRxMetadataOffset ], rxLen ) );
                    *outLen = rxLen;
                    result = true;
                }
            }
    ...
    bool Lwnode::writeAtBytes( const uint8_t * const data, uint16_t len ) const noexcept
    {
        bool result { false };
    ...
    bool Lwnode::readAckBytes( uint16_t * const outLen ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::readLoraData( uint16_t * const outLen ) noexcept
    {
        bool result { false };
    ...
    bool Lwnode::readAckWithYield( uint16_t * const outLen ) noexcept
    {
        bool result { false };
                            ...
                            size_t ackCap ) noexcept
    {
        ...
        if( ( cmdAscii != nullptr ) && ( ackBuf != nullptr ) && ( ackCap >= 2U ) ) 
        {
            ...
            if( cmdLen > 0U )
            {
                ...
                static_cast< void >( std::memcpy( tx, cmdAscii, cmdLen ) );
