...
class TimestreamReader:
    ...
    def _build_multi_measure_query(
        ...
        return (
            ...
            f"SUM(motion) AS motion, "
            f"SUM(motion) AS motion_count, "
            f"COUNT(motion) AS motion_samples, "
    ...
    def _build_legacy_single_measure_query(
        ...
        return (
            ...
            f") AS hum_pct, "
            f"SUM(measure_value::bigint) "
            f"FILTER (WHERE measure_name = 'motion') AS motion, "
            f"SUM(measure_value::bigint) "
            f"FILTER (WHERE measure_name = 'motion') AS motion_count, "
            f"COUNT(measure_value::bigint) "
            f"FILTER (WHERE measure_name = 'motion') AS motion_samples, "
            f"AVG(measure_value::bigint) "
            f"FILTER ("
